        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Active Exams</h2>
                </div>
            </div>
        </div>
                                  ...
                                  <tbody>
                                      <?php 
                                          ...
                                          <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>user/active_exams/<?php echo $student->assessment_id; ?>"><?php echo $student->fullname; ?></a></td>
