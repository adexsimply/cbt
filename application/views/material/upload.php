        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row fx-element-overlay">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="px-15 mt-20 font-size-14">
                                        <p><b>Attachment:</b> <?php if ((($material_info->attachment)!=NULL) AND (($material_info->attachment)!='0')) { 
                                            ...
                                            echo "<a href='$path2' style='color:red;'>View File</a>";
                                             ...
                                             ?></p>
                                        <p><b>Date Added:</b> <?php echo $material_info->date_created; ?></p>
                                        <!-- <p><b>Pages:</b> 560</p> -->
                                        <p><b>Description: </b> <?php echo $material_info->description; ?></p>
                                        <?php if($active_user->role_id==1) {
                                            if (!empty($material_info->attachment_admin)) {
                   ...
                   <?php echo form_open_multipart('material/upload_admin', array('class' => 'publisher bg-transparent bt-1 border-fade'));?>
