        ...
        <div class="col-12 col-lg-3">   
              ...
              <!-- Modal -->
                <div class="modal center-modal fade" id="modal-classes2" tabindex="-1">
                      ...
                      <div class="modal-body">
                        <form id="add-student">
                          ...
                          <div class="box-footer">
                            <button  type="button" title="add_student" onclick="exempt_class()" class="btn btn-info pull-right">Exempt Class</button>
                          </div>
                          <!-- /.box-footer -->
                            <!-- /.box-body -->
                      </div>
