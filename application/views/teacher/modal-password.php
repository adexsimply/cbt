                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form id="add-<?php echo strtolower($title); ?>">
                            ...
                            <div class="box-body">
                              <div class="row">
                                <input type="text"  class="form-control" hidden="" name="teacher_id" id="teacher_id" placeholder=" Example 2014 / 2015">
                                <div class="col-12">
                          ...
                          <div class="box-footer">
                            <button  type="button" title="add_session" type="button" title="add_<?php echo strtolower($title); ?>" onclick="change_password2()" class="btn btn-info pull-right">Confirm</button>
                          </div>
                          <!-- /.box-footer -->
                            <!-- /.box-body -->
                      </div>
